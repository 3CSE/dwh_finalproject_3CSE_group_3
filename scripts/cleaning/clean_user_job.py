...
<<<<<<< HEAD
def run_cleaning():
    """Execute the clean_user_job.sql cleaning script"""
    conn = get_connection()
    if not conn:
    ...
    try:
        ...
        logging.info(f"Executing cleaning script: clean_user_job.sql")
        ...
        logging.info(f"Successfully executed: clean_user_job.sql")
        cursor.close()
        return True
