...
def insert_delivery_logistics_cards():
    ...
    card_layout = [
        ...
        {"name": "Average Delay Days", "position": {"row": 0, "col": 6, "size_x": 6, "size_y": 4}},
    ...
    response.raise_for_status()
    logging.info(f"✅ Delivery & Logistics dashboard populated! View at: {METABASE_URL}/dashboard/{dashboard_id}")
    return dashboard_id

if __name__ == "__main__":
    insert_delivery_logistics_cards()
