...
def insert_customer_segmentation_cards():
    logging.info("Inserting Customer Segmentation Deep Dive cards...")
    session_token = login_to_metabase()
    dashboard_id = get_dashboard_by_name(session_token, "Customer Segmentation Deep Dive")
    
    card_layout = [
        {"name": "Total Customer Segments", "position": {"row": 0, "col": 0, "size_x": 6, "size_y": 4}},
        {"name": "Segment Diversity Index", "position": {"row": 0, "col": 6, "size_x": 6, "size_y": 4}},
        {"name": "Top Segment Revenue", "position": {"row": 0, "col": 12, "size_x": 6, "size_y": 4}},
        {"name": "Top Segment Orders", "position": {"row": 0, "col": 18, "size_x": 6, "size_y": 4}},
        {"name": "Segment AOV Ranking", "position": {"row": 4, "col": 0, "size_x": 12, "size_y": 6}},
        {"name": "Segment Campaign Usage Rate", "position": {"row": 4, "col": 12, "size_x": 12, "size_y": 6}},
        {"name": "Segment Repeat Purchase Rate", "position": {"row": 10, "col": 0, "size_x": 12, "size_y": 6}},
        {"name": "Segment Matrix - Revenue vs Orders", "position": {"row": 10, "col": 12, "size_x": 12, "size_y": 6}},
        {"name": "Age and Gender Analysis", "position": {"row": 16, "col": 0, "size_x": 24, "size_y": 6}},
    ]
    ...
    response.raise_for_status()
    logging.info(f"✅ Customer Segmentation Deep Dive dashboard populated! View at: {METABASE_URL}/dashboard/{dashboard_id}")
    return dashboard_id

if __name__ == "__main__":
    insert_customer_segmentation_cards()
