...
def insert_customer_analytics_cards():
    logging.info("Inserting Customer Analytics cards...")
    session_token = login_to_metabase()
    dashboard_id = get_dashboard_by_name(session_token, "Customer Analytics")
    ...
    response.raise_for_status()
    logging.info(f"✅ Customer Analytics dashboard populated! View at: {METABASE_URL}/dashboard/{dashboard_id}")
    return dashboard_id

if __name__ == "__main__":
    insert_customer_analytics_cards()
