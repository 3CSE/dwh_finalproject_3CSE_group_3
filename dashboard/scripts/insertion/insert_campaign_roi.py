...
def insert_campaign_roi_cards():
    logging.info("Inserting Campaign ROI & Effectiveness cards...")
    session_token = login_to_metabase()
    dashboard_id = get_dashboard_by_name(session_token, "Campaign ROI & Effectiveness")
    
    card_layout = [
        {"name": "Total Campaign Revenue (ROI)", "position": {"row": 0, "col": 0, "size_x": 6, "size_y": 4}},
        {"name": "Total Discount Cost (ROI)", "position": {"row": 0, "col": 6, "size_x": 6, "size_y": 4}},
        {"name": "Net Campaign Profit", "position": {"row": 0, "col": 12, "size_x": 6, "size_y": 4}},
        {"name": "Campaign ROI Percentage", "position": {"row": 0, "col": 18, "size_x": 6, "size_y": 4}},
        {"name": "Campaign AOV Ranking", "position": {"row": 4, "col": 0, "size_x": 12, "size_y": 6}},
        {"name": "Campaign Conversion Funnel", "position": {"row": 4, "col": 12, "size_x": 12, "size_y": 6}},
        {"name": "Discount Efficiency Analysis", "position": {"row": 10, "col": 0, "size_x": 12, "size_y": 8}},
        {"name": "Campaign Performance Scorecard", "position": {"row": 10, "col": 12, "size_x": 12, "size_y": 8}},
        {"name": "Campaign Response by Customer Segment", "position": {"row": 18, "col": 0, "size_x": 24, "size_y": 6}},
    ]
    ...
    response.raise_for_status()
    logging.info(f"✅ Campaign ROI & Effectiveness dashboard populated! View at: {METABASE_URL}/dashboard/{dashboard_id}")
    return dashboard_id

if __name__ == "__main__":
    insert_campaign_roi_cards()
