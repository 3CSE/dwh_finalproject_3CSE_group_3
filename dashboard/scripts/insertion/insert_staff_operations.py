...
def insert_staff_operations_cards():
    logging.info("Inserting Staff & Operations cards...")
    session_token = login_to_metabase()
    dashboard_id = get_dashboard_by_name(session_token, "Staff & Operations")
    
    card_layout = [
        {"name": "Total Staff", "position": {"row": 0, "col": 0, "size_x": 6, "size_y": 4}},
        {"name": "Total Orders Processed by Staff", "position": {"row": 0, "col": 6, "size_x": 6, "size_y": 4}},
        {"name": "Revenue Generated by Staff", "position": {"row": 0, "col": 12, "size_x": 6, "size_y": 4}},
        {"name": "Average Orders per Staff", "position": {"row": 0, "col": 18, "size_x": 6, "size_y": 4}},
        {"name": "Staff Performance by Volume and Revenue", "position": {"row": 4, "col": 0, "size_x": 12, "size_y": 6}},
        {"name": "Performance by Job Level", "position": {"row": 4, "col": 12, "size_x": 12, "size_y": 6}},
        {"name": "Orders by Staff Location", "position": {"row": 10, "col": 0, "size_x": 12, "size_y": 6}},
        {"name": "Delay Impact on Repeat Purchases", "position": {"row": 10, "col": 12, "size_x": 12, "size_y": 6}},
    ]
    ...
    response.raise_for_status()
    logging.info(f"✅ Staff & Operations dashboard populated! View at: {METABASE_URL}/dashboard/{dashboard_id}")
    return dashboard_id

if __name__ == "__main__":
    insert_staff_operations_cards()
